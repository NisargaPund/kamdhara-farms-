        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/faq" className="text-cream/80 hover:text-gold transition-colors">FAQ</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/return-policy" className="text-cream/80 hover:text-gold transition-colors">Return Policy</Link></li>
            </ul>
          </div>
